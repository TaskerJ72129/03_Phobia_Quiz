...
class QuizStats:
    def __init__(self, partner, quiz_history, quiz_stats):
        ...
        if percentage_correct == 100:
            percentage_fg = "green"
            percentage_text = "all correct good job"
        elif percentage_correct == 0:
            percentage_fg = "#af4141"
            percentage_text = "wow you suck"
        else:
        ...
        # percentage correct (row 3)
        self.extra_label = Label(self.details_frame, text=percentage_text,
                                     font=heading, anchor="e", fg=percentage_fg)
        self.extra_label.grid(row=4, column=0, padx=0)
